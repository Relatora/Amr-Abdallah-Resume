module.exports = {
 ...
 <p>In 2019 I enrolled in a postgraduate degree at Lambton College CSAC program (Computer Software & Database Development) where I learned many skills and implemented what I know in projects affiliated to Lambton research center such as developing a digital signage HTML/CSS/JS compiler that takes in a JSON string and automatically downloads assets via WebSocket from the web then maps these assets regardless of dimensions or location dynamically to a full page <strong></strong>Electron JS</strong> browser page and all of that ran on a Raspberry Pi that can be placed behind any screens for display. </p>
